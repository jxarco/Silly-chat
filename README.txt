...
Dos botones para poder cambiar dicha información.
	...
	- Abrir input y selección de avatares haciendo clic.
	- Cerrar pulsando ESC.
...
Cuadro de chat: En el podremos realizar 3 operaciones distintas:
	...
	Enviar usando el botón SEND o la tecla ENTER.
	...
	En los dos tipos de mensajes podremos activar o desactivar la casilla
